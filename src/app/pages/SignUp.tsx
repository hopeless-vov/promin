...
export function SignUp() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-sm">
      <h1 className="text-[28px] font-semibold leading-tight mb-1">Get started</h1>
      <p className="mb-8 text-muted-foreground text-sm">Create a new account</p>
      ...
      {/* Password */}
      <div className="mb-6">
        <label className="block mb-1.5 text-sm text-secondary-foreground">Password</label>
